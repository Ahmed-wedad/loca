...
const FinishTrip = ({current, clearErrors, modalD, activeTabD, toggleModalFinish, finishTrip, msg}) => {
  ...
  const onSubmit = e => {
    e.preventDefault();
    setWaiting(true)
    finishTrip(current.trip_id)
  }


    return (
      <React.Fragment>
            <TabContent activeTab={activeTabD}>
              <TabPane tabId="1">
                <Modal
                  isOpen={modalD}
                ...
                >
                  <ModalHeader toggle={toggleModalFinish}>
                   Finish Trip
                  </ModalHeader>
                  <ModalBody>
                    <CardBody>
