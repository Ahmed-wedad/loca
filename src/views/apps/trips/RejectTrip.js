...
const RejectTrip = ({current, clearErrors, modalB, activeTabB, toggleModalReject, rejectTrip, msg}) => {
      ...
      <React.Fragment>
            <TabContent activeTab={activeTabB}>
              <TabPane tabId="1">
                <Modal
                  isOpen={modalB}
                  toggle={toggleModalReject}
                  className="modal-dialog-centered"
                >
                  <ModalHeader toggle={toggleModalReject}>
                   Reject Trip
                  </ModalHeader>
                  <ModalBody>
                    <CardBody>
